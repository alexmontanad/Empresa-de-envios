                ...
                <tbody>
                    ...
                    <td align='center'>
                        <button class="btn btn-warning"
                            onclick=window.location="../Controladores/envios_controlador.php?accion=recogido&id=<?php echo $reg[$i]['idSolicitud'];?>&paquete=<?php echo $reg[$i]['paquete'];?>&cliente=<?php echo $reg[$i]['cliente'];?>&destinatario=<?php echo $reg[$i]['destinatario'];?>&estado=Recogido">
